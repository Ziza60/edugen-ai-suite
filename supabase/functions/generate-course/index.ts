...
// ═══════════════════════════════════════════════════════════════════
// STAGE 4 — QUALITY ELEVATION PASS
// Supervisor de qualidade de conteúdo: eleva especificidade,
// adequação ao público, exemplos ancorados, takeaways acionáveis
// e densidade. Chamado após refinamento estrutural.
// ═══════════════════════════════════════════════════════════════════
...
✗ "A comunicação é fundamental para construir relacionamentos com clientes."
✓ "Em ciclos B2B com ticket médio acima de R$50k, a cadência de follow-up ideal é 3-5 dias — não 2 semanas, o que sinaliza desinteresse ao comprador econômico."

✗ "Use ferramentas de CRM para registrar informações."
✓ "No Salesforce e HubSpot, crie campos customizados para registrar o Economic Buyer e os Decision Criteria do MEDDIC — sem isso, o gerente perde contexto a cada handoff de oportunidade."
...
Identifique qualquer trecho que explique o básico para um público avançado e eleve o nível.
...
Se o exemplo for genérico demais (sem setor, sem perfil de empresa, sem número), reescreva com um cenário concreto e verossímil mantendo a estrutura Contexto → Desafio → Solução → Resultado.

### Critério 4 — TAKEAWAYS ACIONÁVEIS
Reprovado (platitude): "Construir confiança através de credibilidade e empatia."
Aprovado (acionável): "Antes de cada reunião com o Economic Buyer, prepare 3 métricas do setor dele — taxa de churn, CAC, NPS — para ancorar o valor da solução em números que ele já monitora."
Reescreva qualquer takeaway que seja uma platitude — frases que soam bem mas não dizem ao aluno o que fazer.

### Critério 5 — DENSIDADE DE CONTEÚDO
Reprovado: bullets curtos que apenas nomeiam conceitos sem explicar.
Aprovado: bullets que nomeiam E explicam o porquê ou como aplicar, em 1-2 frases objetivas.
✗ "Use a aversão à perda como gatilho."
✓ "Use a aversão à perda quantificando o custo de não agir: calcule quanto o cliente perde por mês com o problema atual e apresente esse número antes do preço da solução."
...
4. Mantenha INTACTO o que já está aprovado — não mexa na estrutura, emojis, separadores ou seções aprovadas.
...
- Retorne APENAS o markdown melhorado, sem comentários ou explicações do que foi alterado
...
Write 800-1200 words. Be thorough and educational.`;
        ...
        // Step C: Quality Elevation Pass — supervisor de qualidade de conteúdo
        // Eleva especificidade, exemplos ancorados, takeaways acionáveis e densidade.
        ...
        try {
          ...
          const qualityPrompt = buildQualityElevationPrompt(
            ...
            refinedContent,
            title,
            target_audience || "profissionais da área",
            language || "pt-BR",
          );
          ...
          const cleanedQuality = qualityResult
            ...
            .replace(/\n?```$/i, "")
            .trim();
          // Only use if result is plausible (guards against AI returning a summary)
        ...
        // Step D: Save the ELEVATED content
