-- Migration: 20260301215007_58a30573-9762-4822-9072-b9f9caf09cfd.sql
...
-- Migration: 20260301215025_f1de26c5-efed-4fa3-a5a5-bbd82b20cc9e.sql
...
-- Migration: 20260301225812_c1102c5c-5c3b-4205-a7d2-d18ec46aea0c.sql
ALTER TABLE public.profiles ADD COLUMN is_dev boolean NOT NULL DEFAULT false;

-- Migration: 20260301233415_0b61065f-439a-436f-914e-056e967f4b3f.sql
...
-- Migration: 20260302044009_fc4bf968-1ee1-484a-b117-c756042f70f0.sql
...
-- Migration: 20260302163258_ea8d9f5e-a29a-47f3-96da-514b5df112d7.sql
...
-- Migration: 20260302173417_219f4523-ae5b-4cb8-b269-fd7d93bb02a0.sql
...
-- Migration: 20260302203236_b2945cf4-4e76-480b-8527-50be273bfe89.sql
UPDATE subscriptions SET plan = 'pro', updated_at = now() WHERE user_id = '389a5d7f-5d24-46ed-a315-e4e86ec53c3b'

-- Migration: 20260307192219_501b6afe-c404-43de-b7c5-cb826ae703f3.sql
...
-- Migration: 20260311162156_6068737f-ac3e-4b16-a4fe-cd68267d941a.sql
...
-- Migration: 20260311163702_c8663bc9-b2e5-43a3-902b-428de3558693.sql
...
-- Migration: 20260311164625_5708aec6-0ea8-4c83-9f7c-4310f513466b.sql
...
-- Migration: 20260311170908_54984609-e83d-4519-85c7-5ef4a3b50993.sql
...
-- Migration: 20260311193629_ec361f7e-2dae-4c03-848f-ffe20f8c0be0.sql
...
-- Migration: 20260429175506_dcbefb9b-c910-4f8e-8e31-c7b9961db2ea.sql
...
-- Migration: 20260429232132_78d12537-b11b-4f3e-a2bd-dee69a16be29.sql
...
-- Migration: 20260429232154_f3dc39f5-0dc2-45cf-aa86-ca41c2830649.sql
