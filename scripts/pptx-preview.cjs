...
.n{font-size:11px;color:#64748b;font-weight:600}
svg{width:100%;height:auto;border-radius:6px;box-shadow:0 4px 20px rgba(0,0,0,.7);display:block;aspect-ratio:16/9}
</style></head>
<body>
