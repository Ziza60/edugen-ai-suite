...
// A função nasceu em src/lib/utils.ts, no front. Hoje mora no _shared das edge
// functions — quem limpa o markdown é quem o exporta: export-pdf, export-pdf-v2,
// restructure-modules e o pipeline de curso. Este teste veio da branch
// replit/pdf-v2-improvements apontando para o endereço antigo; só o import
// mudou, os quatro casos são os mesmos.
