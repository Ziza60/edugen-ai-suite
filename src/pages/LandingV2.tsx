...
export default function LandingV2() {
  useEffect(() => {
    if (!document.getElementById("landing-v2-fonts")) {
      const link = document.createElement("link");
      link.id = "landing-v2-fonts";
      link.rel = "stylesheet";
  ...
  return (
    <div
      style={{ fontFamily: "'DM Sans', sans-serif", background: "#0B0B0F", color: "#E8E3DC", minHeight: "100vh", overflowX: "hidden" }}
    >
      {/* grain overlay */}
      <div
      ...
      <header
        ...
        style={{ background: "rgba(11,11,15,0.92)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(232,227,220,0.06)" }}
      >
        <div className="container mx-auto flex h-16 items-center justify-between px-6">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            ...
            <div>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.25rem", fontWeight: 700, letterSpacing: "-0.01em", color: "#E8E3DC" }}>
                EduGen AI
              </span>
              <div style={{ fontSize: "9px", letterSpacing: "0.18em", color: "rgba(201,169,110,0.55)", textTransform: "uppercase", lineHeight: 1, marginTop: "-2px" }}>
                Motor Pedagógico
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/auth"
              style={{ fontSize: "0.875rem", fontWeight: 500, padding: "0.5rem 1.25rem", borderRadius: "8px", background: ACCENT, color: "#0B0B0F", border: "none", cursor: "pointer", transition: "opacity 0.2s", letterSpacing: "0.01em" }}
      ...
      <section className="relative container mx-auto px-6 pt-28 pb-36 text-center">
        ...
        <motion.div className="relative z-10" variants={stagger} initial="hidden" animate="visible">
          ...
          <motion.h1
            variants={fadeUp}
            style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2.8rem, 6vw, 5rem)", fontWeight: 600, lineHeight: 1.08, letterSpacing: "-0.02em", marginBottom: "1.5rem", maxWidth: "820px", marginLeft: "auto", marginRight: "auto", color: "#E8E3DC" }}
          >
          ...
          <motion.p
            variants={fadeUp}
            style={{ fontSize: "1.125rem", lineHeight: 1.7, color: "rgba(232,227,220,0.5)", maxWidth: "580px", margin: "0 auto 2.5rem", fontWeight: 300 }}
          >
      ...
      <div style={{ borderTop: "1px solid rgba(232,227,220,0.05)", borderBottom: "1px solid rgba(232,227,220,0.05)", background: "rgba(232,227,220,0.015)", padding: "1.5rem 0" }}>
        <div className="container mx-auto px-6">
          <p style={{ fontSize: "0.6875rem", color: "rgba(232,227,220,0.25)", textAlign: "center", textTransform: "uppercase", letterSpacing: "0.2em", marginBottom: "1rem" }}>
      ...
      <section className="container mx-auto px-6 py-28">
        ...
        >
          <p style={{ fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: GOLD, marginBottom: "1rem", fontWeight: 500 }}>
            Funcionalidades
          </p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "1px", background: "rgba(232,227,220,0.06)", borderRadius: "16px", overflow: "hidden" }}>
          {features.map((f, i) => (
            <motion.div
              key={f.title}
              initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.04 }}
      ...
      <section style={{ borderTop: "1px solid rgba(232,227,220,0.05)", borderBottom: "1px solid rgba(232,227,220,0.05)", padding: "7rem 0" }}>
        <div className="container mx-auto px-6">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }} className="lg:grid-cols-2 grid-cols-1">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "rgba(223,124,58,0.08)", border: "1px solid rgba(223,124,58,0.2)", color: ACCENT, padding: "4px 14px", borderRadius: "100px", fontSize: "0.75rem", fontWeight: 500, marginBottom: "1.5rem", letterSpacing: "0.04em" }}>
                ✦ Exclusivo EduGen AI
              </div>
              ...
              <p style={{ color: "rgba(232,227,220,0.45)", lineHeight: 1.75, marginBottom: "2rem", fontWeight: 300, maxWidth: "480px" }}>
                Após cada geração, o EduScore™ avalia seu curso em 4 dimensões: clareza de linguagem, completude dos objetivos,
                equilíbrio entre teoria e prática, e engajamento do conteúdo.
              </p>
              <Link
                to="/auth"
                ...
                onMouseLeave={(e) => (e.currentTarget.style.opacity = "1")}
              >
                Ver meu EduScore™ <ArrowRight className="h-4 w-4" />
              </Link>
            </motion.div>
                ...
                {eduScoreDimensions.map((d) => (
                  <div key={d.label}>
                    ...
                    <div style={{ height: "4px", background: "rgba(232,227,220,0.06)", borderRadius: "100px", overflow: "hidden" }}>
                      <motion.div
                        style={{ height: "100%", background: d.color, borderRadius: "100px" }}
                        initial={{ width: 0 }}
      ...
      <section className="container mx-auto px-6 py-28">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          ...
          <motion.div
            ...
            style={{ background: "rgba(232,227,220,0.025)", border: "1px solid rgba(232,227,220,0.07)", borderRadius: "16px", padding: "1.5rem", order: 2 }}
          ...
          >
            ...
            {tutorMessages.map((m, i) => (
              <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start", marginBottom: "0.75rem" }}>
                <div style={{
                  maxWidth: "82%", padding: "0.625rem 1rem", borderRadius: "12px", fontSize: "0.8125rem", lineHeight: 1.6,
                  background: m.role === "user" ? `${ACCENT}18` : "rgba(232,227,220,0.05)",
                  border: m.role === "user" ? `1px solid ${ACCENT}28` : "1px solid rgba(232,227,220,0.06)",
                  color: m.role === "user" ? "rgba(232,227,220,0.8)" : "rgba(232,227,220,0.55)",
                }}>
                  {m.text}
                </div>
              </div>
            ...
            <div style={{ marginTop: "0.75rem", paddingTop: "0.75rem", borderTop: "1px solid rgba(232,227,220,0.05)" }}>
              <div style={{ background: "rgba(232,227,220,0.03)", borderRadius: "8px", padding: "0.625rem 0.875rem", fontSize: "0.75rem", color: "rgba(232,227,220,0.18)" }}>
                Pergunte algo sobre o curso…
              </div>
            </div>
          </motion.div>
          ...
          >
            <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "rgba(160,142,194,0.1)", border: "1px solid rgba(160,142,194,0.2)", color: "#A08EC2", padding: "4px 14px", borderRadius: "100px", fontSize: "0.75rem", fontWeight: 500, marginBottom: "1.5rem" }}>
              ✦ Novo
            </div>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem, 3.5vw, 2.5rem)", fontWeight: 600, lineHeight: 1.15, letterSpacing: "-0.02em", color: "#E8E3DC", marginBottom: "1.25rem" }}>
            ...
            <ul style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
              {["Link público sem login do aluno", "Histórico de perguntas no painel do criador", "Baseado 100% no seu conteúdo"].map((item) => (
                <li key={item} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "0.875rem", color: "rgba(232,227,220,0.55)" }}>
                  <CheckCircle className="h-4 w-4 shrink-0" style={{ color: "#7B9E87" }} />
                  {item}
                </li>
              ))}
            </ul>
      ...
      <section style={{ borderTop: "1px solid rgba(232,227,220,0.05)", padding: "7rem 0" }}>
        <div className="container mx-auto px-6">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", maxWidth: "760px", margin: "0 auto" }} className="md:grid-cols-2 grid-cols-1">
            {/* FREE */}
            <motion.div
              ...
              <ul style={{ display: "flex", flexDirection: "column", gap: "0.75rem", marginBottom: "2rem" }}>
                {freePlan.map((item) => (
                  <li key={item} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "0.875rem", color: "rgba(232,227,220,0.45)" }}>
                    <CheckCircle className="h-4 w-4 shrink-0" style={{ color: "rgba(232,227,220,0.2)" }} />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            >
              <div style={{ position: "absolute", top: "-13px", left: "50%", transform: "translateX(-50%)", background: ACCENT, color: "#0B0B0F", fontSize: "0.6875rem", fontWeight: 700, padding: "3px 14px", borderRadius: "100px", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Popular
              </div>
      ...
      <section style={{ padding: "7rem 0", position: "relative", overflow: "hidden" }}>
        ...
        >
          ...
          <p style={{ color: "rgba(232,227,220,0.4)", fontSize: "1.0625rem", marginBottom: "2.5rem", maxWidth: "440px", margin: "0 auto 2.5rem", fontWeight: 300, lineHeight: 1.65 }}>
      ...
      <footer style={{ borderTop: "1px solid rgba(232,227,220,0.05)", padding: "2.5rem 0" }}>
        <div className="container mx-auto px-6" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "2rem" }} >
          <div>
