...
import {
  ...
  Sparkles, Lightbulb, BarChart3, Bot, ExternalLink,
} from "lucide-react";
...
function EmptyState({ navigate }: { navigate: (path: string) => void }) {
  return (
    ...
    >
      ...
      <h3 style={{ ...serif, fontSize: 28, fontWeight: 600, color: C.text, margin: "0 0 10px" }}>
        Nenhum curso ainda
      </h3>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 8px 24px rgba(223,124,58,0.28)",
          marginBottom: 44,
        }}
      >
        <Plus size={15} />
