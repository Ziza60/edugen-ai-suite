...
const freeBenefits = [
  ...
  { text: "Quizzes e flashcards", included: true },
  ...
  { text: "Flashcards interativos", included: false },
  { text: "Branding próprio", included: false },
];

const proBenefits = [
  { text: "Até 10 cursos por mês", included: true },
  ...
  { text: "Certificado personalizável", included: true },
  { text: "Sem branding EduGen", included: true },
  { text: "Exportação PDF", included: true },
  { text: "Exportação PowerPoint", included: true },
